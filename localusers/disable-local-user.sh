...
usage () {
	...
	echo "A local Linux account to be disabled, deleted, and optionally archived." >&2
	echo ' -d	Disable accounts instead of disabling them.' >&2
	echo ' -r	Removes the home directory associated with the account(s).' >&2
	echo ' -a	Crates an archive of the home directory associated with the accounts(s) and stores the archive in the /archives directory.' >&2
	exit 1
}
