...
# A pasword will be automatically generated for the account.
# The userrname, password, and host for the account will be displayed.

# Make sure the script is being executed with superuser privileges.

if [[ "${UID}" -ne 0 ]]
then 
	echo 'Plesase run with sudo or as root.' >&2
	exit 1
fi
